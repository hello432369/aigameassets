...
ART_STYLE = (
    ...
    "NO shadow, NO ground shadow, NO drop shadow. "
...
CHAR_STYLE = (
    ...
    "no ground shadow, no drop shadow under or around the character. "
...
GRID_RULES = (
    ...
    "6. NO shadows anywhere — no drop shadow, no ground shadow."
)
...
GRID_RULES_4X4 = (
    ...
    "7. NO shadows anywhere — no drop shadow, no ground shadow, no character shadow."
)
